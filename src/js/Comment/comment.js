...
const comment = (container) => 
{
    ...
    const showPastComment = () => 
    {
        ...
        const commentsRef = firebase.database().ref(`${projectName}/`).orderByChild(`frompage`).equalTo(location.pathname)
